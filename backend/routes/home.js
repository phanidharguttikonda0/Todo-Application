...
const {todoCheck, authorizationCheck,usernameCheck} = require('../middleware/Todos') ;
...
router.post('/start-todo/:todoId', authorizationCheck, usernameCheck, async (req, res,next) => {
...
router.delete('/delete-completed-todos/:todoId', authorizationCheck, usernameCheck, async (req,res) =>{}) ;

router.delete('/delete-current-todos/:todoId', authorizationCheck, usernameCheck, async (req,res) => {}) ;

router.patch('/update-todo/:todoId', authorizationCheck, usernameCheck,async (req,res,next) =>{
...
router.post('/mark-as-done/:todoid', authorizationCheck, usernameCheck, async (req,res,next) => {
    const result = await TodoApp.findOne({username: req.username, "todos._id": req.params.todoid}, {"todos.$": 1}) ;
